...
class LossAccountingManifest:
    ...
    Attributes:
        ...
        events_skipped: Number of events skipped.
        fields_mapped: List of source fields successfully mapped.
        fields_lost: List of source fields that could not be mapped.
        missingness_rates: Per-field missingness rates (0.0-1.0).
        config_hash: SHA-256 hash of the adapter configuration.
    ...
    def compute_config_hash(self, config: dict) -> str:
        """Compute SHA-256 hash of adapter configuration."""
        import hashlib
